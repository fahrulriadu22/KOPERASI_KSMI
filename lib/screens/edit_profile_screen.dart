  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      if (passwordResult['success'] == true) {
        ...
        // ✅ PANGGIL CALLBACK DENGAN DATA YANG SAMA (karena hanya ganti password)
        ...
        print('❌ Password change failed: ${passwordResult['message']}');
        
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Gagal mengubah password: ${passwordResult['message']}'),
